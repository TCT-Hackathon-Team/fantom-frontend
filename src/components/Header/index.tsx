...
const Header = ({ t }: any): JSX.Element => {
  ...
  const MenuItem = () => {
    ...
    const [isSingupModalOpen, setSignupModalOpen] = useState(false);
      ...
      <>
        ...
        {account === null ? (
          <>
            ...
            >
              <Span>
                <CustomButton>{t("Sign up")}</CustomButton>
              </Span>
            </CustomNavLinkSmall>
          </>
        ) : (
          <>
            ...
            <CustomNavLinkSmall onClick={() => navigate("/create-wallet")}>
